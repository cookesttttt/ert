              ...
              <Form ref="editMaintenanceData" :model="editMaintenanceData" :rules="ruleInline" :label-width="100">
                ...
                <Col span="12">
                  <FormItem label="维修时间" prop="repairDate">
                    <DatePicker
                      v-model="editMaintenanceData.repairDate"
                      type="date"
                      class="width"
                      format="yyyy-MM-dd"
                      :transfer="true"
                ...
                <Col span="12">
                  <FormItem label="维修类型" prop="repairType">
                    <Select v-model="editMaintenanceData.repairType" class="width">
                ...
                <Col span="12">
                  <FormItem label="维修单位" prop="repairCompany">
                    <Input v-model="editMaintenanceData.repairCompany" class="width" :maxlength="15"></Input>
                  </FormItem>
                </Col>
                <Col span="12">
                  <FormItem label="维修费用" prop="repairCost">
                    <Input v-model="editMaintenanceData.repairCost" class="width" :maxlength="12"></Input>
                  </FormItem>
                </Col>
                <Col span="12">
                ...
                <Col span="12">
                  <FormItem label="故障原因" prop="reason">
                    <Input v-model="editMaintenanceData.reason" type="textarea" :autosize="{minRows: 3,maxRows:3}"
                           class="width" :maxlength="255"></Input>
                  </FormItem>
                </Col>
                <Col span="12">
                  <FormItem label="检修结果" prop="result">
                    <Input v-model="editMaintenanceData.result" type="textarea" :autosize="{minRows: 3,maxRows:3}"
                           class="width" :maxlength="255"></Input>
                  </FormItem>
                </Col>
              </Form>
...
<script>
  ...
  import {editData,deleteImgData,getEditData,deleteDevice} from '@/api/EquipmentMaintenance/maintenanceRecords'
  ...
  export default {
            ...
            this.$refs.xTable.validate((valid) => {
              if (valid) {
                const data = {
                  ...
                  'repairDate': this.editMaintenanceData.repairDate,
                  'repairType': this.editMaintenanceData.repairType,
                  'repairCompany': this.editMaintenanceData.repairCompany,
                  'repairCost': this.editMaintenanceData.repairCost,
                  'transactor': this.editMaintenanceData.transactor,
                  'reason': this.editMaintenanceData.reason,
                  'result': this.editMaintenanceData.result,
        ...
        getEditData(this.itemId).then(res => {
          ...
          switch (status) {
            ...
            default:
              ...
              this.editMaintenanceData.repairDate=new Date(data.msgData.repairDate)
              this.editMaintenanceData.repairType=data.msgData.repairType
              this.editMaintenanceData.repairCompany=data.msgData.repairCompany
              this.editMaintenanceData.repairCost=data.msgData.repairCost+''
              this.editMaintenanceData.transactor=data.msgData.transactor
              this.editMaintenanceData.reason=data.msgData.reason
              this.editMaintenanceData.result=data.msgData.result
              this.tableData=data.msgData.equipmentRepairDetailVos
    ...
    activated() {
      this.itemId=sessionStorage.getItem('editMaintenanceRecordsId')
      this.getEcho()
    }
  }
</script>
