              ...
              <Form ref="newMaintenanceData" :model="newMaintenanceData" :rules="ruleInline" :label-width="100">
                ...
                <Col span="12">
                  <FormItem label="保养时间" prop="maintenanceDate">
                    <DatePicker
                      v-model="newMaintenanceData.maintenanceDate"
                      type="date"
                      class="width"
                      format="yyyy-MM-dd"
                      :transfer="true"
                ...
                <Col span="12">
                  <FormItem label="保养类型" prop="maintenanceType">
                    <Select v-model="newMaintenanceData.maintenanceType" class="width">
                ...
                <Col span="12">
                  <FormItem label="保养单位" prop="maintenanceCompany">
                    <Input v-model="newMaintenanceData.maintenanceCompany" class="width" :maxlength="15"></Input>
                  </FormItem>
                </Col>
                <Col span="12">
                  <FormItem label="保养费用" prop="maintenanceCost">
                    <Input v-model="newMaintenanceData.maintenanceCost" class="width" :maxlength="12"></Input>
                  </FormItem>
                </Col>
                <Col span="12">
                ...
                <Col span="12">
                  <FormItem label="保养情况" prop="maintenanceCondition">
                    <Input v-model="newMaintenanceData.maintenanceCondition" type="textarea" :autosize="{minRows: 3,maxRows:3}"
...
<script>
  ...
  import {newData,deleteImgData} from '@/api/EquipmentMaintenance/engineAttendance'
            ...
            this.$refs.xTable.validate((valid) => {
              if (valid) {
                const data = {
                  ...
                  'maintenanceDate': this.newMaintenanceData.maintenanceDate,
                  'maintenanceType': this.newMaintenanceData.maintenanceType,
                  'maintenanceCompany': this.newMaintenanceData.maintenanceCompany,
                  'maintenanceCost': this.newMaintenanceData.maintenanceCost,
                  'transactor': this.newMaintenanceData.transactor,
                  'maintenanceCondition': this.newMaintenanceData.maintenanceCondition,
