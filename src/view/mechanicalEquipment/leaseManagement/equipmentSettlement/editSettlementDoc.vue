            ...
            <Form ref="information" :model="information" :rules="ruleInline" :label-width="100">
                <Col span="12">
                  <FormItem label="付款日期" prop="payDate">
                    <DatePicker v-model="information.payDate" type="date"  class="width" format='yyyy-MM-dd'></DatePicker>
                  </FormItem>
                </Col>
                ...
                <Col span="12">
                  <FormItem label="经办人" prop="operator">
                    <Input v-model="information.operator" class="width" :maxlength="10"></Input>
                  </FormItem>
                </Col>
                <Col span="12">
                ...
                <Col span="12">
                  <FormItem label="备注">
                    <Input v-model="information.remark" class="width" type="textarea" :autosize="{minRows: 3,maxRows:3}" :maxlength="300"></Input>
                  </FormItem>
                </Col>
            </Form>
          </Col>
...
<script>
  ...
  import '../index.less'
  import {deleteImgData, getDataEcho, editData, deleteEquipment} from '@/api/leaseManagement/equipmentSettlement'
  ...
  export default {
      ...
      saveOrder(state) {
        ...
        this.$refs.information.validate((valid) => {
          if (valid) {
            ...
            editData(data,JSON.parse(localStorage.getItem("projectId")).id,this.itemId).then(res => {
              const data = res.data
        ...
        getDataEcho(this.itemId).then(res => {
          ...
          switch (status) {
            ...
            default:
              ...
              this.information.billNumber=data.msgData.billNumber
              this.information.payDate=new Date(data.msgData.payDate)
              this.information.contractNumber=data.msgData.contractNumber
              this.information.contractName=data.msgData.contractName
              this.information.blank=data.msgData.blank
              this.information.blankAccount=data.msgData.blankAccount
              this.information.payEe=data.msgData.payEe
              this.information.payableAmount=data.msgData.payableAmount.toString()
              this.information.actualAmount=data.msgData.actualAmount.toString()
              this.information.deductExpense=data.msgData.deductExpense.toString()
              this.information.subsidy=data.msgData.subsidy.toString()
              this.information.operator=data.msgData.operator
    ...
    activated() {
      console.log(sessionStorage.getItem('equipmentSettlementId'))
      this.itemId = sessionStorage.getItem('equipmentSettlementId')
      this.getEcho()
    }
  }
</script>
