            ...
            <Form ref="information1" :model="information" :rules="ruleInline" :label-width="100">
              <br><br>
                <Col span="24">
                  <FormItem label="停租日期" prop="leaseOffDate">
                    <DatePicker v-model="information.leaseOffDate" type="date"  class="width" format='yyyy-MM-dd' :transfer="true"></DatePicker>
                  </FormItem>
                </Col>
                <Col span="24">
              ...
              <Col span="24">
                <FormItem label="停租原因" prop="cause">
                  <Input v-model="information.cause" type="textarea" :autosize="{minRows: 3,maxRows: 5}" class="width" :maxlength="128"></Input>
                </FormItem>
              </Col>
...
<script>
  ...
  import {getNumber,deleteImgData,newLeaseContract } from '@/api/leaseManagement/offHire'
