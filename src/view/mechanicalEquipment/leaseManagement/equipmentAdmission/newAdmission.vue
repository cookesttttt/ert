          ...
          <Form ref="information" :model="information" :rules="ruleInline" :label-width="100">
              <Col span="24">
                <FormItem label="入场时间" prop="inDate">
                  <DatePicker v-model="information.inDate" type="date"  class="width" format='yyyy-MM-dd' :transfer="true"></DatePicker>
                </FormItem>
              </Col>
              <Col span="24">
              ...
              <Col span="24">
                <FormItem label="查验结论" prop="checkResult">
                  <Input v-model="information.checkResult" type="textarea" :autosize="{minRows: 3,maxRows:3}" class="width" :maxlength="128"></Input>
                </FormItem>
              </Col>
          </Form>
        </Col>
...
<script>
  ...
  import '../index.less'
  import { newLease, deleteImgData} from '@/api/leaseManagement/equipmentAdmission'
