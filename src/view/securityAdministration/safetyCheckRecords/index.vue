<template>
  <Card style="height: 100%">
    <div class="bottom15">
      <Button class="search-btn" type="primary" @click="clickNewQualityInspectionRecords">&nbsp;新建安全检查</Button>
      <!--收搜-->
      <div class="right">
...
<script>
  ...
  import {allData,deleteTable} from '@/api/securityAdministration/safetyCheckRecords'
    export default {
        name: "index",
      data() {
        return {
      ...
      methods: {
        clickNewQualityInspectionRecords(){
          this.$router.push({path: '/securityAdministration/newSafetyCheckRecords'})
        },
        // 获取全部数据
        //删除数据
