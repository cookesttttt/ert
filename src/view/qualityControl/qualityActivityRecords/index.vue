<template>
  <Card style="height: 100%">
    <div class="bottom15">
      <Button class="search-btn" type="primary" @click="clickNewQualityActivityRecords">&nbsp;新建质量事故记录</Button>
      <!--收搜-->
      <div class="right">
...
<script>
  ...
  import {allData,deleteTable} from '@/api/qualityControl/qualityActivityRecords'
  export default {
    name: "index",
    data() {
      return {
    ...
    methods: {
      clickNewQualityActivityRecords(){
        this.$router.push({path: '/qualityControl/newQualityActivityRecords'})
      },
      //删除数据
