<template>
  <Card style="height: 100%">
    <div class="bottom15">
      <Button class="search-btn" type="primary" @click="clickNewQualityServices">&nbsp;新建质量事务</Button>
      <!--收搜-->
      <div class="right">
...
<script>
  ...
  import {allData,deleteTable} from '@/api/qualityControl/qualityServices'
  export default {
    name: 'shareMe',
    data() {
      return {
    ...
    methods: {
      clickNewQualityServices(){
        this.$router.push({path: '/qualityControl/newQualityServices'})
      },
      //删除数据
