<template>
  <Card style="height: 100%">
    <div class="bottom15">
      <Button class="search-btn" type="primary" @click="clickNewQualityInspectionRecords">&nbsp;新建质量检查</Button>
      <!--收搜-->
      <div class="right">
...
<script>
  ...
  import {allData,deleteTable} from '@/api/qualityControl/qualityInspectionRecords'
    export default {
        name: "index",
      data() {
        return {
      ...
      methods: {
        clickNewQualityInspectionRecords(){
          this.$router.push({path: '/qualityControl/newQualityInspectionRecords'})
        },
        // 获取全部数据
        //删除数据
