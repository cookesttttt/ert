<template>
  <Card style="height: 100%">
    <div class="bottom15">
      <Button class="search-btn" type="primary" @click="clickNewQualityObjectives">&nbsp;新建质量目标</Button>
      <!--收搜-->
      <div class="right">
        <Input class="search-input" placeholder="请输入名称收搜" v-model="searchValue"></Input>
        <Button class="search-btn" type="primary" @click="searchQualityObjectives">
...
<script>
  ...
  import {allData,deleteTable} from '@/api/qualityControl/qualityObjectives'
    export default {
      ...
      methods:{
        clickNewQualityObjectives(){
          this.$router.push({path: '/qualityControl/newQualityObjectives'})
        },
        //删除数据
